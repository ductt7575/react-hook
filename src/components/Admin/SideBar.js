...
import { FaTachometerAlt, FaList, FaGithub, FaReact } from "react-icons/fa";
    ...
    <>
      ...
      >
        <SidebarHeader>
          ...
          >
            <Link to={`/`} className="text-decoration-none">
              ...
              />
              <span className="text-light d-inline-block mt-1 ms-2 fs-6">
                {t("appName")}
              </span>
            </Link>
          </div>
        ...
        <SidebarFooter style={{ textAlign: "center" }}>
          ...
          >
            <a
              href="https://github.com/ductt7575"
              target="_blank"
